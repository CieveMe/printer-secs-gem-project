...
set "ZPL=%~dp0zebra-media-calibrate.zpl"
if not exist "%ZPL%" (
  echo Zebra media calibration ZPL was not found:
  echo   %ZPL%
  pause
  exit /b 1
)
...
echo Sending Zebra media calibration command:
echo   %ZPL%
echo To USB printer:
echo   "%USB_ADDRESS%"
...
echo Waiting for printer media calibration...
