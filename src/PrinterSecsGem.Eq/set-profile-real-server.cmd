...
echo Deployment profile updated: REAL_SERVER.
echo.
echo This PC runs SECS/GEM and ERACK Server only.
echo Unit clients should connect to this PC on port 7801.
